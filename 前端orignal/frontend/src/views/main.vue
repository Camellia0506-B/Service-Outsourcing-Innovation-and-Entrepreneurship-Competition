...
const navItems = ref([
    ...
    },
    {
        ...
        children: [
            { 
                text: '职业测评', 
                path: '/main/career-planning/assessment' 
            },
            { 
                text: '能力画像', 
                path: '/main/career-planning/profile' 
            },
            { 
                text: '岗位匹配', 
                path: '/main/career-planning/matching' 
            }
        ],
        activeChild: null
    },
...
const handleChildClick = (parentIdx, childIdx, event) => {
    ...
    // 新增主题判断逻辑（系统设置现在是navItems的第四个元素）
    if (parentIdx === 3) {
        // 获取主题模式
