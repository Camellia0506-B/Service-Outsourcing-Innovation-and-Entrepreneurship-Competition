  ...
  var defaultStore = {
    students: [
      ...
      },
      {
        ...
        gpaLevel: '良好',
        systemMatchScore: 79,
        abilityTags: ['Vue.js', 'React', 'TypeScript', 'Node.js', 'UI设计'],
        highlight: '主导开发校级选课系统前端，日活500+，有完整产品上线经验',
        isOpenToContact: true
      },
      {
        ...
        userId: 5,
        educationLevel: '本科',
        majorCategory: '数据科学与大数据技术',
        gpaLevel: '中等',
        systemMatchScore: 72,
        abilityTags: ['数据分析', 'Python', 'SQL', 'Tableau', 'Excel'],
        highlight: '美赛H奖，熟悉数据清洗与可视化，有电商数据分析实习经历',
        isOpenToContact: true
      }
    ],
    invitations: [
